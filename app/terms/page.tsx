      ...
      <div className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-8">
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                ...
                on the platform ("User Content"). By sharing content, you grant
                Explorer Circle a worldwide, non-exclusive, royalty-free license
                to use, display, and distribute your content within the
                platform.
              </p>
              <p>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Explorer Circle is provided "as is" and "as available" without any
